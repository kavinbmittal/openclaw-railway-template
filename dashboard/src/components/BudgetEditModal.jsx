     ...
     <div>
      ...
      <div className="relative">
       ...
       <input
        ...
        className="w-full bg-background border border-border px-3 py-2 pl-7 text-sm font-mono tabular-nums focus:outline-none focus:ring-1 focus:ring-ring"
        placeholder="0.00"
       />
      </div>
     </div>
        ...
        {perAgentLimits.map((item, i) => (
         <div key={i} className="flex items-center gap-2">
          <input
           ...
           className="flex-1 bg-background border border-border px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-ring"
          ...
          <div className="relative w-28">
           ...
           <input
            ...
            className="w-full bg-background border border-border px-3 py-1.5 pl-5 text-sm font-mono tabular-nums focus:outline-none focus:ring-1 focus:ring-ring"
            placeholder="0.00"
           />
          </div>
          <button
