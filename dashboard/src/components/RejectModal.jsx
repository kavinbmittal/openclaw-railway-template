      ...
      <div className="relative border border-border bg-background p-6 w-full max-w-md space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <textarea
            ...
            rows={3}
            className="w-full bg-secondary border border-border px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 resize-none focus:outline-none focus:border-ring"
          />
